...
need('CMakeLists.txt','VERSION 0.2.10.55','src/algorithms/planet_detector.cpp')
...
need('docs/openapi.yaml','version: 0.2.10.55','PlanetarySerBlock:','mountCorrections:','roiShiftThresholdPx:')
