...
need('CMakeLists.txt','VERSION 0.2.10.47','src/algorithms/planet_detector.cpp')
...
need('docs/openapi.yaml','version: 0.2.10.47','PlanetarySerBlock:','mountCorrections:','roiShiftThresholdPx:')
