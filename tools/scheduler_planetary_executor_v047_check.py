...
need('CMakeLists.txt','VERSION 0.2.10.60','src/algorithms/planet_detector.cpp')
...
need('docs/openapi.yaml','version: 0.2.10.60','PlanetarySerBlock:','mountCorrections:','roiShiftThresholdPx:')
