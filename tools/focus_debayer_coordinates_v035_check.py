...
checks={
 'release version': 'VERSION 0.2.10.35' in cmake,
...
if failed: raise SystemExit(f'{len(failed)} v0.2.10.35 assertion(s) failed')
...
print(f'focus/debayer/coordinates v0.2.10.35: PASS ({len(checks)} assertions)')
