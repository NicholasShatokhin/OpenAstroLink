...
need(Path('CMakeLists.txt'),'VERSION 0.2.7','OAS_ENABLE_NATIVE_GEMINI','OAS_ENABLE_NATIVE_SKYWATCHER','QHYCCD_INCLUDE_DIR','QHYCCD_LIBRARY')
...
need(Path('src/tools/hardware_probe.cpp'),'require-native-telescope','Native telescope pack: OK')
