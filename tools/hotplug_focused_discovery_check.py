...
need('drivers/qhy/oal_driver_qhy.manifest.json', '0.2.10.16')
need('drivers/gemini/oal_driver_gemini.manifest.json', '0.2.10.16')
need('drivers/skywatcher/oal_driver_skywatcher.manifest.json', '0.2.10.16')
