...
need(Path('CMakeLists.txt'),'VERSION 0.2.10.35','adaptive_plate_solve.cpp','oal-adaptive-plate-solve-smoke')
...
need(Path('docs/openapi.yaml'),'/solve/adaptive:','version: 0.2.10.35')
