...
has('CMakeLists.txt','VERSION 0.2.10.55','current release version')
...
has('docs/RELEASE_0.2.10.55.md','High-rate camera streaming','release note')
...
has('src/core/application_controller.cpp','QtConcurrent::run','preview processing off acquisition thread')
...
has('src/oal/oal_ws_server.cpp','QtConcurrent::run','JPEG encoding off event-loop thread')
