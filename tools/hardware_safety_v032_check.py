...
need('src/gui/main_window.cpp','Save user captures as science files','Sync mount to last successful plate solve','MOUNT MODEL','Invert Axis 1 mapping / tracking direction','Clear native OAL Park calibration')
