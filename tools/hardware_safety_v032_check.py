...
need('src/backends/oal_native_devices.cpp','writeFitsScienceFrame','OpenAstroLink/','Mechanical Park is not calibrated','if(parking_&&!abortMotion(e))','rawAxisGoto(target,15.0')
need('src/gui/main_window.cpp','Save user captures as science files','Sync mount to last successful plate solve','SYNC SAFETY','Reverse Axis 1 mapping / tracking direction','Clear mechanical Park calibration (disable Park)')
