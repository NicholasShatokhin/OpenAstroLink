...
need('src/algorithms/autofocus_engine.cpp',
     'meterSceneExposure','starting focus position %1 restored','tileScores','framesPerPosition = std::clamp',
     'Scene focus peak was not bracketed','sceneFocusScore','255.0 / 65535.0','cancelAndRestore','candidate peak was not repeatable')
...
need('docs/openapi.yaml','version: 0.2.10.59','startAtUtc:')
need('docs/SCHEDULER.md','v0.2.10.49','waiting-camera')
print(f'PASS v0.2.10.59 AF/exposure/scheduler lifecycle: {checks} assertions')
