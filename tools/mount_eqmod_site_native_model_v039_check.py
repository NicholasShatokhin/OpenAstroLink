...
def need(path,*tokens):
    ...
    return text
need('CMakeLists.txt','project(OpenAstroSuite VERSION 0.2.10.45')
...
need('src/core/application_controller.cpp','coordinate model migrated to v7','profile_.mount.axis1Sign=1','profile_.mount.axis2Sign=1','profile_.mount.autoHomeSync=true','ASCOM backend site adopted into OpenAstroLink profile','resolvedEndpoint="EQMOD.Telescope"')
...
need('tests/mount_geometry_smoke.cpp','EQDrive v7 Moon HIL transform failed','44.307735','77.299641')
