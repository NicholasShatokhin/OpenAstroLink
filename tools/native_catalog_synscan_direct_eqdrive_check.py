...
for token in ['official EQDrive ASTEP','read("St"','read("Pos"','read("Cg"','Goto %1 %2','Access is denied','eqmod-gem-ha-dec-v9','no hidden driver-level sky GOTO qualification cap']:
