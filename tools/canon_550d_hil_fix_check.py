...
checks={
 ...
 "Canon session transfer path validated": 'EdsSetObjectEventHandler' in canon and 'EdsSetPropertyData(SaveTo=Host)' in canon and 'Canon EDSDK session ready: object-transfer handler registered' in canon,
