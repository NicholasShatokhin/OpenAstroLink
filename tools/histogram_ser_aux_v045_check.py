...
gui=need('src/gui/main_window.cpp','sensor-scale proportional controller','std::pow(std::clamp(ratio,0.08,12.0),0.72)','relativeError<0.08','f->addRow("Offset",liveOffset_)','Observatory device classes — API placeholders')
...
need('docs/openapi.yaml','version: 0.2.10.45')
