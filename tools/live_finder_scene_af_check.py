...
checks = {
    'CMakeLists.txt': ['VERSION 0.2.10.50'],
    ...
    'src/gui/main_window.cpp': ['Live / Finder', 'Finder Alignment wizard', 'Scene autofocus (auto-meter + safe contrast search)', 'No robust bright region detected' if False else 'Bright target: no robust bright region detected'],
