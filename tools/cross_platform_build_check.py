...
need(Path('CMakeLists.txt'),
     'VERSION 0.2.10','OAS_CANON_TRANSPORT','CANON_EDSDK_INCLUDE_DIR','CANON_EDSDK_LIBRARY',
...
need(Path('drivers/canon/oal_driver_canon_edsdk.cpp'),
     ...
     'kEdsCameraCommand_BulbStart','host.publishFrame','0.2.10')
need(Path('CMakeUserPresets.example.json'),
     'my-windows-observatory','my-linux-observatory','CANON_EDSDK_RUNTIME_DIR','QHYCCD_RUNTIME_DIR')
