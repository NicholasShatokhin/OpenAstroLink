...
require(Path('CMakeLists.txt'),'VERSION 0.2.7','oal_driver_qhy','oal_driver_gemini','oal_driver_skywatcher','OAL_DRIVER_BUILD_DIR')
...
require(Path('src/tools/hardware_probe.cpp'),'Native OAL:','Native QHY: OK','Native Gemini EAF:','Native Sky-Watcher:','INDI compatibility:','nativeBackendKey')
require(Path('scripts/install_rpi_node.sh'),'/usr/local/lib/openastrolink/drivers','*.manifest.json')
require(Path('scripts/bootstrap_rpi_observatory.sh'),'qt6-httpserver-dev','--with-indi','libopencv-dev','oal.qhy','oal.gemini','oal.skywatcher')
