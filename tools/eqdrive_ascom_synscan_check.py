...
cmake=need('CMakeLists.txt','project(OpenAstroSuite VERSION 0.2.10.44','OAS_ENABLE_NATIVE_EQDRIVE','OAS_ENABLE_ASCOM_CLASSIC','oal_driver_eqdrive','oas-ascom-host','src/backends/synscan_app_mount.cpp','src/backends/synscan_network_mount.cpp')
...
assert manifest['driverId']=='oal.eqdrive' and manifest['version']=='0.2.10.44' and 'mount' in manifest['deviceClasses']
