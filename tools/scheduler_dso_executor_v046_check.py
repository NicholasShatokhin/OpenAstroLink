...
need('CMakeLists.txt','VERSION 0.2.10.46')
...
need('src/core/application_controller.cpp',
     ...
     'r.saveRaw=true','everyNFrames','Planetary SER block model is available, but its autonomous executor is not enabled')
...
need('docs/SCHEDULER.md','v0.2.10.46 introduces the first real, non-durable DSO executor','Sync + correction slew','planetary-ser')
need('docs/uk/SCHEDULER.md','v0.2.10.46','Sync + correction slew','planetary-ser')
need('docs/openapi.yaml','version: 0.2.10.46','ObservationBlock:','DsoFitsBlock:','/sessions/current/plan:')
print('scheduler ObservationPlan + supervised DSO executor v0.2.10.46: PASS')
