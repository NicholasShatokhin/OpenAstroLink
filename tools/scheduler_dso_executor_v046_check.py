...
need('CMakeLists.txt','VERSION 0.2.10.53')
...
need('src/algorithms/scheduler.cpp','"prepare-block"','status_.state = "completed"','b.dso.exposure.saveRaw = true')
...
need('src/core/application_controller.cpp',
     ...
     'currentImagingTarget(*block)','startAdaptiveSolve(r','startAutofocus(d.autofocus.request','startCapture(r',
...
need('docs/openapi.yaml','version: 0.2.10.53','ObservationBlock:','DsoFitsBlock:','/sessions/current/plan:')
print('scheduler ObservationPlan + retained DSO executor v0.2.10.53: PASS')
