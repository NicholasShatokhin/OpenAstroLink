...
need('docs/openapi.yaml','version: 0.2.10.60','ObservationBlock:','DsoFitsBlock:','/sessions/current/plan:')
print('scheduler ObservationPlan + retained DSO executor v0.2.10.60: PASS')
