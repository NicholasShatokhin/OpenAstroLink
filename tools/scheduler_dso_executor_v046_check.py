...
need('docs/SCHEDULER.md','v0.2.10.48','Sync + correction slew','planetary-ser')
need('docs/uk/SCHEDULER.md','v0.2.10.48','Sync + correction slew','planetary-ser')
need('docs/openapi.yaml','version: 0.2.10.48','ObservationBlock:','DsoFitsBlock:','/sessions/current/plan:')
print('scheduler ObservationPlan + retained DSO executor v0.2.10.48: PASS')
