...
const char*manifest(void*){return copyString(R"({"driverId":"oal.zwo.eaf","name":"OpenAstroLink native ZWO EAF focuser driver","version":"0.2.10.13","abiVersion":2,"threadModel":"per-device-serial","transport":"ZWO EAF SDK"})");}
...
OalDriverV2 api{OAL_DRIVER_ABI_V2,sizeof(OalDriverV2),OAL_DRIVER_FEATURE_EVENTS|OAL_DRIVER_FEATURE_CANCELLATION|OAL_DRIVER_FEATURE_HEALTH,"oal.zwo.eaf","OpenAstroLink native ZWO EAF focuser driver","0.2.10.13",nullptr,&manifest,&start,&stop,&devices,&caps,&health,&invoke,&cancel,&releaseString};
}
