...
> **Current development checkpoint:** v0.2.10.58-buildfix9. Raspberry Pi 4 and Pi 5 are treated as the generic Linux `aarch64` target; the ARM64 node/probe/native-driver build is confirmed, while Pi 5 physical runtime/HIL remains pending.
