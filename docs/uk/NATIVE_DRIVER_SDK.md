...
У v0.2.10 reference drivers: simulated, QHY, Canon, ZWO ASI/EAF, Gemini та Sky-Watcher. Out-of-process sandbox залишається важливим наступним hardening layer.
