...
> **Поточний реліз:** v0.2.10.51. Direct SynScan/EQDrive Wi-Fi та serial EQDrive зберігають HIL-кваліфіковану v9 Core geometry; polarity/geometry не змінювати без нових HIL доказів.
