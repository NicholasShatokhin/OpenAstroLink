...
> **Поточний реліз:** v0.2.10.51. Raspberry Pi 4 і Pi 5 трактуються як generic Linux `aarch64` target; ARM64 node/probe/native-driver build підтверджений, physical Pi 5 runtime/HIL ще pending.
