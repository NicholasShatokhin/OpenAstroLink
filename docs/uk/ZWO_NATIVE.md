...
> **Поточний development checkpoint:** v0.2.10.58-buildfix9. Native ZWO ASI/EAF лишаються default OAL drivers; ARM64 vendor libraries пройшли повний Raspberry Pi cross-build.
