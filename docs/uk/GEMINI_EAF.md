...
> **Поточний development checkpoint:** v0.2.10.58-buildfix9. Native `oal.gemini` лишається default focuser integration; попередній Windows motion HIL результат збережено.
