...
> **Current development checkpoint:** v0.2.10.58-buildfix9. Classic ASCOM remains an optional Windows compatibility backend; native OAL drivers are the default.
