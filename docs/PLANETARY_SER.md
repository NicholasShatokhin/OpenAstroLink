...
> **Current development checkpoint:** v0.2.10.58-buildfix9. Planetary SER remains implemented; real-hardware workflow hardening continues under the Beta HIL plan.
...
A SER file produced by OpenAstroLink has been opened successfully in AutoStakkert on real data. Remaining high-rate qualification is frame-count/telemetry reconciliation and a 5–10 minute zero-record-drop run on the new streaming path.
