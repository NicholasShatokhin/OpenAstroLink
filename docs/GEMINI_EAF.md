...
> **Current development checkpoint:** v0.2.10.58-buildfix9. The native `oal.gemini` path remains the default focuser integration; its earlier Windows motion HIL result is retained.
