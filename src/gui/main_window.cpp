...
QWidget *MainWindow::buildSkyMapPanel(){
    ...
    connect(skyMap_,&SkyMapWidget::selectionChanged,this,[this](const QString&,double,double){updateSkySelectionText();refreshSkyMapContext();});
