...
QWidget *MainWindow::buildMountTab(){
    ...
    siteTime->addWidget(mountUseSystemUtc_,1,0,1,3);siteTime->addWidget(mountConversionUtc_,1,3,1,3);siteTime->addWidget(saveSite,2,0,1,2);siteTime->addWidget(detectSite,2,2,1,2);siteTime->addWidget(applySiteTime,2,4,1,2);siteTime->addWidget(mountSiteTimeStatus_,3,0,1,6);l->addWidget(siteTimeBox);
