...
private:
    ...
    void appendLog(const QString&); void showError(const QString&); void updateAstrometryOverlay(); void updateStarMap(); void updateHistogram(const QImage &image);
    ...
    QCheckBox *histogramEnabled_{}; QCheckBox *histogramAutoExposure_{}; QLabel *histogramView_{}; QLabel *histogramStats_{}; QDoubleSpinBox *histogramTarget_{}; QPushButton *histogramApplyButton_{}; double histogramSuggestedExposure_{0.0};
    ...
    QDoubleSpinBox *mountRa_{}; QDoubleSpinBox *mountDec_{}; QComboBox *mountFrame_{}; QLabel *mountStatus_{}; QCheckBox *mountTracking_{}; QCheckBox *mountParked_{};
